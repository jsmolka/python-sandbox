...
class Fireworks:
    x = None
    y = None
    d = fireworks_diameter  # Diameter
    v = None  # Vertical velocity
    g = vertical_gravity  # Vertical gravity
    c = None  # Color
    exploded = None
    particles = None
    ...
    class Particle:
        x = None
        y = None
        d = particle_diameter  # Diameter
        vv = None  # Vertical velocity
        hv = None  # Horizontal velocity
        vg = vertical_gravity  # Vertical gravity
        c = None  # Color
        faded = False
        fading_steps = particle_fading_steps
    ...
    def explode(self):
        ...
        for i in range(0, particle_count):
            p = Fireworks.Particle(self.x, self.y, self.d)
